...
plot(X, Y, x_interp, y_interp, 'rx');
xlabel('X');
ylabel('Y');
title('Функция из лабораторной работы №7');
...
disp(['Значение в точке x_interp для 1-ой производной: ', num2str(dy_dx_interp)]);
disp(['Значение в точке x_interp для 2-ой производной: ', num2str(d2y_dx2_interp)]);
